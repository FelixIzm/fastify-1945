      ...
      var _cookie = {};
        request(options, function (error, response, body) {
          if(error){
            ...
            //data_t = `{"query":{"bool":{"should":[{"bool":{"should":[{"match_phrase":{"document_type":"������ ���������, ����������"}},{"match_phrase":{"document_type":"������ ������� � ������������"}},{"match_phrase":{"document_type":"������ � ������ ���������"}},{"match_phrase":{"document_type":"����������"}},{"match_phrase":{"document_type":"������� ������ ��������"}},{"match_phrase":{"document_type":"��������� � ��������"}},{"match_phrase":{"document_type":"�������"}},{"match_phrase":{"document_type":"�������������"}},{"match_phrase":{"document_type":"�������"}},{"match_phrase":{"document_type":"�������"}},{"match_phrase":{"document_type":"���������������� ��������� � ���������"}},{"match_phrase":{"document_type":"��������"}},{"match_phrase":{"document_type":"�����"}},{"match_phrase":{"document_type":"����� ��������"}},{"match_phrase":{"document_type":"�����"}},{"match_phrase":{"document_type":"�����"}},{"match_phrase":{"document_type":"�������"}},{"match_phrase":{"document_type":"������ ���������"}}]}},{"bool":{"should":[{"bool":{"must":[{"range":{"date_from":{"lte":"${finish_date}"}}},{"range":{"date_to":{"gte":"${start_date}"}}}],"boost":3}},{"bool":{"must":[{"range":{"document_date_b":{"lte":"${finish_date}"}}},{"range":{"document_date_f":{"gte":"${start_date}"}}}],"boost":7}}]}},{"bool":{"should":[{"match_phrase":{"authors_list.keyword":{"query":"${military_unit}","boost":50}}},{"match":{"document_name":{"query":"${military_unit}","type":"phrase","boost":30}}},{"match":{"authors":{"query":"${military_unit}","type":"phrase","boost":20}}},{"match":{"army_unit_label.division":{"query":"${military_unit}","type":"phrase","boost":10}}},{"nested":{"path":"page_magazine","query":{"bool":{"must":[{"match":{"page_magazine.podrs":{"query":"${military_unit}","type":"phrase"}}},{"range":{"page_magazine.date_from":{"lte":"${finish_date}"}}},{"range":{"page_magazine.date_to":{"gte":"${start_date}"}}}]}},"boost":4}}]}}],"minimum_should_match":3}},"_source":["id","document_type","document_number","document_date_b","document_date_f","document_name","archive","fond","opis","delo","date_from","date_to","authors","geo_names","operation_name","secr","image_path","delo_id","deal_type","operation_name"],"size":"${size_rec}","from":"${from_rec}"}`;
